...
import com.example.nyarubox.comm.GlideSimpleLoader;
import com.example.nyarubox.comm.MyGlideEngine;
import com.example.nyarubox.db.GroupDao;
import com.example.nyarubox.db.NoteDao;
import com.example.nyarubox.db.bean.Group;
import com.example.nyarubox.db.bean.Note;
import com.example.nyarubox.ui.BaseActivity;
import com.example.nyarubox.util.CommonUtil;
import com.example.nyarubox.util.ContentUriUtil;
import com.example.nyarubox.util.ImageUtils;
import com.example.nyarubox.util.SDCardUtil;
import com.example.nyarubox.util.StringUtils;
import com.example.nyarubox.view.RichTextEditor;
import com.example.nyarubox.view.imagewatcher.ImageWatcherHelper;
import com.example.nyarubox.view.matisse.Matisse;
import com.example.nyarubox.view.matisse.MimeType;
import com.example.nyarubox.view.matisse.internal.entity.CaptureStrategy;
...
//                .choose(MimeType.ofAll())
                ...
                .captureStrategy(new CaptureStrategy(true, "com.example.nyarubox.view.matisse.fileprovider"))//存储到哪里
